...
export const sampleDetail: ProductDetail = {
  ...
  colors: [
    { id: "c1", label: "Clear sky", image: u(SNEAKER_IDS[0], 200, 240) },
    { id: "c2", label: "Indigo", image: u(SNEAKER_IDS[1], 200, 240) },
    { id: "c3", label: "Grey", image: u(SNEAKER_IDS[2], 200, 240) },
  ],
  sizes: [
    { label: "UK 6" },
...
export const shortsDetail: ProductDetail = {
  ...
  colors: [
    { id: "s1", label: "Azurblau", image: u(APPAREL_IDS[0], 200, 240) },
    { id: "s2", label: "Blue", image: u(APPAREL_IDS[1], 200, 240) },
    { id: "s3", label: "Grey", image: u(APPAREL_IDS[2], 200, 240) },
    { id: "s4", label: "Lime", image: u(APPAREL_IDS[3], 200, 240) },
  ],
  sizes: [
    { label: "XS" },

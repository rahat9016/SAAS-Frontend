      ...
      <div className="py-6 lg:py-8 pb-20 lg:pb-12">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
          ...
          <aside className="hidden lg:block w-64 shrink-0">
            <div className="sticky top-[130px] bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm">
              {/* User Card */}
                  ...
                  <div key={section.title}>
                    ...
                    {section.items.map((item) => {
                      ...
                      return (
                        ...
                        >
                          <item.icon size={16} className={isActive ? "text-primary" : "text-gray-400"} />
                          {item.label}
                        </Link>
                      );
                    })}

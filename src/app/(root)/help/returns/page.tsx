...
const steps = [
  { icon: RotateCcw, title: "Start your return", text: "Go to your Orders page and select the items within 30 days of delivery." },
...
const faqs = [
  ...
  { q: "What if my item is faulty?", a: "Contact support — faulty items are returned free and refunded in full, even after 30 days." },
];
  ...
  return (
    <div className="container px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="overflow-hidden rounded-3xl bg-gradient-to-r from-secondary to-primary p-8 text-white md:p-10">
        ...
        <h1 className="mt-3 text-3xl font-bold md:text-4xl">30-day return policy</h1>
        <p className="mt-2 max-w-xl text-sm opacity-90">
          Changed your mind? You have 30 days from delivery to send items back for a full refund — returns are always free.
        </p>
      </div>
